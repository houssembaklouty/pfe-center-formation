...
<head>
    ...
    <title>Condidat Register | {{ config('app.name') }}</title>
        ...
        <div class="col-md-6">
            <div class="card mx-4">
                <div class="card-body p-4">
                    <form method="post" action="{{ route('condidat.register') }}" enctype="multipart/form-data">
                        @csrf
                        <h1>Register</h1>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control {{ $errors->has('niveau')?'is-invalid':'' }}" name="niveau" value="{{ old('niveau') }}"
                                   placeholder="Niveau">
                        ...
                        <a href="{{ route('condidat.login') }}" class="text-center">I already have a membership</a>
                    </form>
                </div>
            </div>
        </div>
